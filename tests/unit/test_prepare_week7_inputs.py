...
from event_driven_audio_analytics.smoke.prepare_week7_inputs import (
    HIGH_ENERGY_TRACK,
    SAMPLE_RATE_HZ,
    SILENT_ORIENTED_TRACK,
    VALIDATION_FAILURE_TRACK,
    prepare_week7_inputs,
)
...
def test_prepare_week7_inputs_creates_expected_metadata_and_audio(tmp_path: Path) -> None:
    paths = prepare_week7_inputs(tmp_path)
