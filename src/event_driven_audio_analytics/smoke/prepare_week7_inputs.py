"""Prepare deterministic Week 7 demo inputs under the shared artifacts mount."""
...
def prepare_week7_inputs(output_root: Path) -> dict[str, str]:
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("artifacts/demo_inputs/week7"),
        help="Directory used to stage the Week 7 demo inputs.",
    )
    args = parser.parse_args()
    paths = prepare_week7_inputs(args.output_root.resolve())
