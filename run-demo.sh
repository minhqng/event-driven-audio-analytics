...
echo "Run 'bash ./scripts/demo/generate-dashboard-evidence.sh' for the review/dashboard evidence path."
echo "Run 'bash ./scripts/demo/generate-demo-evidence.sh' for the full final evidence bundle."
echo "Run 'bash ./scripts/demo/run-local-fma-burst.sh' after placing local FMA data under 'data/local/fma_metadata/tracks.csv' and 'data/local/fma_small/...' for a bounded FMA-small burst."
echo "See './docs/runbooks/demo.md' for the final demo sequence and front door."
