...
Write-Host "Run '.\\scripts\\demo\\generate-dashboard-evidence.ps1' for the review/dashboard evidence path."
Write-Host "Run '.\\scripts\\demo\\generate-demo-evidence.ps1' for the full final evidence bundle."
Write-Host "Run '.\\scripts\\demo\\run-local-fma-burst.ps1' after placing local FMA data under 'data\\local\\fma_metadata\\tracks.csv' and 'data\\local\\fma_small\\...' for a bounded FMA-small burst."
Write-Host "See '.\\docs\\runbooks\\demo.md' for the final demo sequence and front door."
